...
OFILES = gba.o font.o main.o input.o images/background.o images/startscreen.o images/cheese.o images/lossscreen.o images/winscreen.o images/rat_image_noback.o images/trap_im.o hit_detec.o movement.o
